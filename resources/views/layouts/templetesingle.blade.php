...
<head>
    ...
    <link href="{{URL::to('/')}}/css/media_query.css" rel="stylesheet" type="text/css"/>
    ...
    <link href="{{URL::to('/')}}/css/owl.theme.default.css" rel="stylesheet" type="text/css"/>
    <!-- Bootstrap CSS -->
    <link href="{{URL::to('/')}}/css/style_1.css" rel="stylesheet" type="text/css"/>
    <!-- Modernizr JS -->
    <script src="{{URL::to('/')}}/js/modernizr-3.5.0.min.js"></script>
</head>
<body>
    ...
    <div class="container">
        <div class="row">
            <div class="col-12 col-md-3 fh5co_padding_menu">
                <img src="{{URL::to('/')}}/images/ednovate.png" alt="img" class="fh5co_logo_width"/>
            </div>
            <div class="col-12 col-md-9 align-self-center fh5co_mediya_right">
                ...
                <div class="text-center d-inline-block">
                    <a class="fh5co_display_table" href="#"><div class="fh5co_verticle_middle"><i class="fa fa-google-plus"></i></div></a>
                </div>
                <div class="text-center d-inline-block">
                    <a href="#" target="_blank" class="fh5co_display_table"><div class="fh5co_verticle_middle"><i class="fa fa-twitter"></i></div></a>
                </div>
                <div class="text-center d-inline-block">
                    <a href="https://web.facebook.com/shuffle.ddie" target="_blank" class="fh5co_display_table"><div class="fh5co_verticle_middle"><i class="fa fa-facebook"></i></div></a>
                </div>
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                <ul class="navbar-nav mr-auto">
                    ...
                    @if (Route::has('login'))
                        @auth
                        <li class="nav-item">
                        <a href="{{ url('/admin/home') }}" class="nav-link">Dashbard<span class="sr-only">(current)</span></a>
                        @else
...
<div class="container-fluid fh5co_footer_bg pb-3">
    <div class="container animate-box">
        <div class="row">
            <div class="col-12 spdp_right py-5"><img src="{{URL::to('/')}}/images/ednovate.png" alt="img" class="footer_logo"/></div>
            <div class="clearfix"></div>
